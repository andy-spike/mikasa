...
const { changePlans, completions, courses, courseSpecs, generationRuns, lessons, outlines, users } =
...
const { listPublishedPlansAction, undoPlanRevisionAction } = await import("@/lib/actions/tailor");
