...
export function tutorSystemPrompt(context: TutorContext): string {
  ...
  return [
    ...
    "",
    "You can change nothing in the Course. You have no tools and no way",
    "to edit Lessons, the Outline, or any Course state. If the Learner",
    "asks for a change, say what you would change in words only — the",
    "Tailor panel is where changes happen, not you.",
    "",
    "The Course:",
